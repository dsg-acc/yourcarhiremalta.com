...
function vrcSetLocOpenTimeModule(loc, where) {
	...
	jQuery.ajax({
		type: "POST",
		url: "'.JRoute::_('index.php?option=com_vikrentcar&task=ajaxlocopentime&tmpl=component&Itemid=' . $params->get('itemid', 0)).'",
...
jQuery(function() {
	...
	jQuery('.vr-cal-img, .vrc-caltrigger').click(function() {
		...
		echo "<div class=\"vrcsfentrycont\"><div class=\"vrcsfentrylabsel\"><label for=\"pickupdatemod".$randid."\">" . JText::_('VRMPICKUPCAR') . "</label><div class=\"vrcsfentrydate\"><input type=\"text\" name=\"pickupdate\" id=\"pickupdatemod".$randid."\" size=\"10\" autocomplete=\"off\" onfocus=\"this.blur();\" readonly/><i class=\"" . VikRentCarIcons::i('calendar', 'vrc-caltrigger') . "\"></i></div></div><div class=\"vrcsfentrytime\"><label>" . JText::_('VRMALLE') . "</label><div class=\"vrc-sm-time-container\"><span id=\"vrcmodselph\"><select name=\"pickuph\">" . $hours . "</select></span><span class=\"vrctimesep\">:</span><span id=\"vrcmodselpm\"><select name=\"pickupm\">" . $minutes . "</select></span></div></div></div>\n";
		echo "<div class=\"vrcsfentrycont\"><div class=\"vrcsfentrylabsel\"><label for=\"releasedatemod".$randid."\">" . JText::_('VRMRETURNCAR') . "</label><div class=\"vrcsfentrydate\"><input type=\"text\" name=\"releasedate\" id=\"releasedatemod".$randid."\" size=\"10\" autocomplete=\"off\" onfocus=\"this.blur();\" readonly/><i class=\"" . VikRentCarIcons::i('calendar', 'vrc-caltrigger') . "\"></i></div></div><div class=\"vrcsfentrytime\"><label>" . JText::_('VRMALLEDROP') . "</label><div class=\"vrc-sm-time-container\"><span id=\"vrcmodseldh\"><select name=\"releaseh\">" . $hoursret . "</select></span><span class=\"vrctimesep\">:</span><span id=\"vrcmodseldm\"><select name=\"releasem\">" . $minutesret . "</select></span></div></div></div>";
    	...
    	<div class="vrc-searchmod-section-sbmt">
			<div class="vrcsfentrycont">
				<div class="vrcsfentrysubmit">
					<button type="submit" class="btn vrcsearch"><?php echo (strlen($params->get('srchbtntext')) > 0 ? $params->get('srchbtntext') : JText::_('SEARCHD')); ?></button>
				</div>
			</div>
		</div>
    </form>
