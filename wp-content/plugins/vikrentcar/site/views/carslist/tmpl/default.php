			...
			<div class="vrc-car-result-rightinner">
				<div class="vrc-car-result-rightinner-deep">
					<div class="vrc-car-result-inner">
						<span class="vrc-car-name">
							<a href="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=cardetails&carid='.$c['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo (strlen($vcategory) ? '<span class="vrc-car-name-category">' . $vcategory . ':</span> ' : '') . $c['name']; ?></a>
						</span>
