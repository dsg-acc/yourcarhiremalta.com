...
<div class="vrc-shell-wrap">
	<p class="vrc-shell-top-bar"><?php echo $cron_data['cron_name']; ?> - <span><?php echo JText::_('VRCCRONEXECRESULT'); ?>:</span> <?php var_dump($run_res); ?></p>
...
function checkShellHeight() {
	...
	var shell_height = jQuery(".vrc-shell-wrap").height();
	if (shell_height < page_height) {
		var diff_height = page_height - shell_height - 10;
		jQuery(".vrc-shell-body").css('height', "+="+diff_height+'px');
	}
}
</script>
