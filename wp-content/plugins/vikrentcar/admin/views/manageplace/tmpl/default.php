				...
				<div class="vrc-params-wrap">
					...
					<div class="vrc-params-container">
						...
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting"><input type="text" name="lat" value="<?php echo count($row) ? $row['lat'] : ''; ?>" size="30"/></div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::_('VRCPLACELNG'); ?></div>
							<div class="vrc-param-setting"><input type="text" name="lng" value="<?php echo count($row) ? $row['lng'] : ''; ?>" size="30"/></div>
						</div>
						<div class="vrc-param-container">
									...
									<div class="vrc-param-loc-wopening-wday">
										<div class="vrc-param-loc-wopening-wday-head">
											<div class="vrc-param-loc-wopening-wday-head-inner">
												...
												<a style="display: <?php echo isset($wopening[$d_ind]) ? 'none' : 'block'; ?>;" class="vrc-param-loc-toggle-on" href="javascript: void(0);" id="vrc-wopen-on-<?php echo $d_ind; ?>" onclick="vrcToggleWopening('on', '<?php echo $d_ind; ?>');"><?php VikRentCarIcons::e('plus-circle'); ?></a>
												<a style="display: <?php echo isset($wopening[$d_ind]) ? 'block' : 'none'; ?>;" class="vrc-param-loc-toggle-off" href="javascript: void(0);" id="vrc-wopen-off-<?php echo $d_ind; ?>" onclick="vrcToggleWopening('off', '<?php echo $d_ind; ?>');"><?php VikRentCarIcons::e('minus-circle'); ?></a>
											</div>
										</div>
										<div class="vrc-param-loc-wopening-wday-override" style="display: <?php echo isset($wopening[$d_ind]) ? 'block' : 'none'; ?>;" id="wopening-<?php echo $d_ind; ?>">
