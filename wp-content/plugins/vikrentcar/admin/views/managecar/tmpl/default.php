...
if (count($morei)) {
	foreach ($morei as $ki => $mi) {
		if (!empty($mi)) {
			...
			$actmoreimgs .= '<a class="vrc-rm-extraimg-lnk" onclick="return confirm(\'' . addslashes(JText::_('VRCDELCONFIRM')) . '\');" href="index.php?option=com_vikrentcar&task=removemoreimgs&carid='.$row['id'].'&imgind='.$ki.'"><i class="'.VikRentCarIcons::i('times-circle').'"></i></a>';
					...
					<div class="vrc-params-container">
						...
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting">
								<input type="number" min="1" name="units" id="vrc-units-inp" value="<?php echo count($row) ? $row['units'] : ''; ?>" size="3" onfocus="this.select();"/>
				...
				<div class="vrc-params-wrap">
					...
					<div class="vrc-params-container">
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting"><textarea name="short_info" rows="4" cols="60"><?php echo count($row) ? $row['short_info'] : ''; ?></textarea></div>
						</div>
						<div class="vrc-param-container">
				...
				<div class="vrc-params-wrap">
					...
					<div class="vrc-params-container">
						...
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting"><input type="number" step="any" name="startfrom" value="<?php echo count($row) ? $row['startfrom'] : ''; ?>" style="width: 100px !important;"/> <?php echo $currencysymb; ?></div>
						</div>
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting"><input type="text" id="car_email" name="email" value="<?php echo count($row) ? $car_params['email'] : ''; ?>"/></div>
						</div>
						<div class="vrc-param-container">
						...
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting"><textarea name="metakeywords" id="metakeywords" rows="3" cols="40"><?php echo count($row) ? $car_params['metakeywords'] : ''; ?></textarea></div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::_('VRCPARAMDESCRIPTIONMETATAG'); ?></div>
							<div class="vrc-param-setting"><textarea name="metadescription" id="metadescription" rows="4" cols="40"><?php echo count($row) ? $car_params['metadescription'] : ''; ?></textarea></div>
						</div>
