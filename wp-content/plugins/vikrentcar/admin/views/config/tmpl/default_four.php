		...
		<div class="vrc-params-wrap">
			...
			<div class="vrc-params-container">
				<div class="vrc-param-container">
					...
					<div class="vrc-param-setting"><input type="text" name="fronttitle" value="<?php echo VikRentCar::getFrontTitle(); ?>" size="30"/></div>
				</div>
				<div class="vrc-param-container">
				...
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo $vrc_app->createPopover(array('title' => JText::_('VRCONFIGATTACHICAL'), 'content' => JText::_('VRCONFIGATTACHICALHELP'))); ?> <?php echo JText::_('VRCONFIGATTACHICAL'); ?></div>
					<div class="vrc-param-setting">
