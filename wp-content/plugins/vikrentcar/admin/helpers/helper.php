...
class VikRentCarHelper
{
	public static function printHeader($highlight = "")
	{
		...
		<div class="vrc-menu-container">
			<div class="vrc-menu-left"><img src="<?php echo VRC_ADMIN_URI . (!empty($backlogo) ? 'resources/'.$backlogo : 'vikrentcar.png'); ?>" alt="VikRentCar Logo" /></div>
			<div class="vrc-menu-right">
				<ul class="vrc-menu-ul"><?php
					...
					?><li class="vrc-menu-parent-li">
						...
						<ul class="vrc-submenu-ul">
							<li><span class="<?php echo ($highlight=="crons" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentcar&amp;task=crons"><?php echo JText::_('VRCMENUCRONS'); ?></a></span></li>
