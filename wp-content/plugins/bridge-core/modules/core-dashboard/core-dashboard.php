<?php
update_option( 'bridge_purchase_info' , [ 'purchase_code' => 'Activated' ] );
update_option( 'bridge_import_params', [ 'submit' => 'import-demo-data', 'url' => 'https://bridgelanding.qodeinteractive.com' ] );
	...
	class BridgeCoreDashboard {
		...
		function register_purchase_code() {
			...
			parse_str( $data_string, $data );
				...
				$data['purchase_code'] = '6184023-5516-4847-81e7-28e0e2b5e590';
			$data['email'] = 'nulled@weadown.com';
		...
		function check_purchase_code( $demo ) {
			...
			$url = add_query_arg( array(
				'purchase_code' => '5E0B5F8-DD8689E6-ACA49DD6-E6E1A930',
				'action'        => 'check',
				'profile'       => 'qode',
				'demo'          => $demo
			), $this->validation_url );
		...
		function get_purchased_code() {
			...
			return '5E0B5F8-DD8689E6-ACA49DD6-E6E1A930';
		}
