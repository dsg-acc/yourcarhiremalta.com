...
<html>
	<head>
        ...
        ?>
		<?php if (isset($adminSide)): ?>
		<link rel="stylesheet" type="text/css" href="<?php echo PJ_INSTALL_URL; ?>app/web/css/admin-calendar.css">
		<script src="<?php echo PJ_INSTALL_URL; ?>app/web/js/dialog-polyfill.min.js"></script>
		<?php endif; ?>
	</head>
	<body>
		<div id="wrapper">
