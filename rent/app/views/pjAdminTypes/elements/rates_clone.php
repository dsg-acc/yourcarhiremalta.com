<table id="tblRatesClone" style="display: none">
	<tbody>
		<tr data-idx="{INDEX}" data-category="{CATEGORY}" class="priceTableRow">
			<td style="display:none">
				<div class="form-group">
					<div class="input-group"> 
						<input type="text" data-category="{CATEGORY}" name="date_from[{INDEX}]" id="date_from_{INDEX}" class="form-control datepick required dateFromSelector" readonly="readonly" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" /> 
			...
			<td style="display:none">
				<div class="form-group">
					<div class="input-group"> 
						<input type="text" data-category="{CATEGORY}" name="date_to[{INDEX}]" id="date_to_{INDEX}" class="form-control datepick required dateToSelector" readonly="readonly" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" /> 
						<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
					</div>
				</div>
			</td>
