...
<?php if ($hasAccessScriptLocations || $hasAccessScriptPayments): ?>
    <li<?php echo $isScriptLocations || $isScriptTimeController || $isScriptPaymentsController ? ' class="active"' : NULL; ?>>
